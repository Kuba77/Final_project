...
//     test("render ProductPrice", () => {
//         render(
//             <ProductPrice product={product.currentPrice} />
//         );
//         screen.debug();
//     });

//     test("ProductPrice have class attribute", () => {
//      const{getByTestId} = render(
//         <p data-testid="test" className="test">&#36; {product.price}</p>
//       );
