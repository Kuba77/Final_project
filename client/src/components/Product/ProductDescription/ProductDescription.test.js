...
//   publisher: "Shueisha",
//   description: "Somewhere in Tokyo, there is a room.",
//   "vol": 37,
//   "country": "Japan",
//   "itemNo": "841621",
...
//   __v: 0
// }
// describe("Testing of ProductDescription component", () => {
//   test("render ProductDescription", () => {
//     render(
//       <ProductDescription className="class" description={product.description} />
//     );
//     screen.debug();
//   });

//   it("ProductDescription shows right info", () => {
//     render(
//       <ProductDescription className="class" description={product.description} />
//     );
//     expect(screen.getByText(/Somewhere in Tokyo, there is a room./i)).toBeInTheDocument();
//   });
// });